        ...
        execute: function () {
            ...
            _export("ProxyFactory", ProxyFactory = function () {
                ...
                _createClass(ProxyFactory, null, [{
                    key: "create",
                    value: function create(objectInstance, props, action) {
                        ...
                        return new Proxy(objectInstance, {
                            get: function get(target, prop, receiver) {
                                ...
                                if (props.includes(prop) && ProxyFactory._isFunction(target[prop])) {
                                    return function () {
                                        ...
                                        var callback = Reflect.apply(target[prop], target, arguments);
                                        action(target);
                                        return callback;
                                    };
                                }
                            ...
                            set: function set(target, prop, value, receiver) {
                                ...
                                var callback = Reflect.set(target, prop, value, receiver);
